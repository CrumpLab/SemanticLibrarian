...
a_sims <- get_search_article_similarities(c("memory","perception","attention"),
                                            query_type=3)
the_df <- get_mds_article_fits(num_articles = 150 ,
...
Now, to compute the vectors for the centers of each cluster, get the keywords, and add them into a plotly plot.
